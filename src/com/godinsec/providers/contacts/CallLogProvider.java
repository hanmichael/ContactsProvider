...
import static com.godinsec.providers.contacts.util.DbQueryUtils.checkForSupportedColumns;
import static com.godinsec.providers.contacts.util.DbQueryUtils.getEqualityClause;
import static com.godinsec.providers.contacts.util.DbQueryUtils.getInequalityClause;
...
import com.godinsec.providers.contacts.util.SelectionBuilder;
...
public class CallLogProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.godinsec.call_log";
    ...
    public static final Uri CALLS_CONTENT_URI = Uri.parse("content://com.godinsec.call_log/calls");

    /**
     * The content:// style URL for filtering this table on phone numbers
     */
    public static final Uri CALLS_CONTENT_FILTER_URI =
            Uri.parse("content://com.godinsec.call_log/calls/filter");
    ...
    static {
        ...
        sURIMatcher.addURI(AUTHORITY, "calls/#", CALLS_ID);
        sURIMatcher.addURI(AUTHORITY, "calls/filter/*", CALLS_FILTER);
    }
    ...
    public boolean onCreate() {
        ...
        mUseStrictPhoneNumberComparation = true;
...
//                    com.android.internal.R.bool.config_use_strict_phone_number_comparation);
    ...
    public Uri insert(Uri uri, ContentValues values) {
    	android.util.Log.i("Godinsec", "godinsec contacts cp calllog insert---:" + uri + "--value:" + values);
        waitForAccess(mReadAccessLatch);
        ...
        android.util.Log.i("Godinsec", "godinsec contacts cp calllog insert  rowId---:" + rowId);
        if (rowId > 0) {
            android.util.Log.i("Godinsec", "godinsec contacts cp calllog insert  newuri---:" + ContentUris.withAppendedId(uri, rowId));
    ...
    private DatabaseModifier getDatabaseModifier(DatabaseUtils.InsertHelper insertHelper) {
        android.util.Log.d("Godinsec", "godinsec contacts cp calllog DatabaseModifier---------");
    ...
    private void checkVoicemailPermissionAndAddRestriction(Uri uri,
        ...
        if (false/*isAllowVoicemailRequest(uri)*/) {
            if (isQuery) {
...
//                            Calls.ALLOW_VOICEMAILS_PARAM_KEY));
    ...
    */
    ...
    private void syncEntriesFromPrimaryUser(UserManager userManager) {
        ...
        final Uri uri = ContentProvider.maybeAddUserId(CALLS_CONTENT_URI,
